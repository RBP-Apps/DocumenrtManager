...
export default function VideoPage() {
  ...
  const videoUrls: Record<string, string> = {
    admin: "https://youtu.be/wmXN3aBbJOM?si=J_r0PAIlGOqkHsz3",
    user: "https://youtu.be/wmXN3aBbJOM",
  };
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto"> {/* Remove min-h-screen, add proper padding */}
                ...
                {!isVideoPlaying ? (
                  <div className="h-80 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-gray-600 mb-2">Click to play the help video</p>
                    </div>
                  </div>
                ) : (
